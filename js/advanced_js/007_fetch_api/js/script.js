...
*/
 ...
 // отправка формы через JSON
     ...
     //           request.send(jsonFormData);  вместо этого используем fetch api
/*
                fetch('http://localhost:8080/request/', { //fetch api post for @ModelAttribute параметры запроса 
                    method: "POST",
                    body: formData
                }).then(data => {
                    console.log(data);
...
*/
                ...
                fetch('http://localhost:8080/request/json', { //fetch api post for @RequestBody json object
                method: "POST",
                headers: {
  ...
  /*      fetch('https://jsonplaceholder.typicode.com/todos/1') // GET запрос fetch
            .then(response => response.json()) //response.json() возвращается в promise возвращает JSON
            .then(json => console.log(json)); */

 /*         fetch('https://jsonplaceholder.typicode.com/posts', { // POST запрос fetch
              method: "POST",
