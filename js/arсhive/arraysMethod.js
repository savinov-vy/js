...
// // для работы с массиво подобными структурами существует способ 
//    for of (имеет возможность использовать break или continue )
// for (let value of arr) {
//     console.log(value);
// }

// // call back функция выполнится строго после выполения forEach
//    (лучше использовать его если не нужно использовать break или continue )
